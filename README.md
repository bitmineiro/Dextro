![Example-Logo](https://i.imgur.com/HjmRcMi.png)
# Dextro Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Dextro Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/5auwwvX)
***
## Requirements
1) **1,000 DXO coins.**
...
***Step 1***
* Download and install the Dextro wallet [here](https://github.com/dextrocoin/dextro/releases)
***

***Step 2***
* Send EXACLY 1,000 DXO coins to a receive address within your wallet.
***
